...
<head>
    ...
    <!-- Bootstrap -->
    <link href="{{asset('Layout_zend/asset/bootstrap/dist/css/bootstrap.min.css')}}" rel="stylesheet">
    <!-- Font Awesome -->
    <link href="{{asset('Layout_zend/css/font-awesome/css/font-awesome.min.css')}}" rel="stylesheet">
    <!-- NProgress -->
    <link href="{{asset('Layout_zend/asset/nprogress/nprogress.css')}}" rel="stylesheet">
    <!-- iCheck -->
    <link href="{{asset('Layout_zend/asset/iCheck/skins/flat/green.css')}}" rel="stylesheet">
    <!-- bootstrap-progressbar -->
    <link href="{{asset('Layout_zend/asset/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css')}}" rel="stylesheet">
    <!-- Custom Theme Style -->
    <link href="{{asset('Layout_zend/css/custom.min.css')}}" rel="stylesheet">
    <!-- Custom Theme Style -->
    <link href="{{asset('Layout_zend/css/mycss.css')}}" rel="stylesheet">
</head>
<body class="nav-md">
...
<!-- jQuery -->
<script src="{{asset('Layout_zend/js/jquery/dist/jquery.min.js')}}"></script>
<!-- Bootstrap -->
<script src="{{asset('Layout_zend/asset/bootstrap/dist/js/bootstrap.min.js')}}"></script>
<!-- FastClick -->
<script src="{{asset('Layout_zend/js/fastclick/lib/fastclick.js')}}"></script>
<!-- NProgress -->
<script src="{{asset('Layout_zend/asset/nprogress/nprogress.js')}}"></script>
<!-- bootstrap-progressbar -->
<script src="{{asset('Layout_zend/asset/bootstrap-progressbar/bootstrap-progressbar.min.js')}}"></script>
<!-- iCheck -->
<script src="{{asset('Layout_zend/asset/iCheck/icheck.min.js')}}"></script>
<!-- Custom Theme Scripts -->
<script src="{{asset('Layout_zend/js/custom.min.js')}}"></script>
</body>
</html>