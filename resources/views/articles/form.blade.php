  ...
  use App\Helpers\Template as Template;
    ...
    $formLabelClass =  config('config.template.form_label.class');
     ...
     $elements = [
        ...
        [
            'label' =>  Form::label('content','content',['class'=>$formLabelClass]),
        ...
        [
            'label' =>  Form::label('category_id','category',['class'=>$formLabelClass]),
            'element' =>Form::select('category_id', $itemsCategory, '',['class'=>$formInputClass]),
        ],
